...
public class global {
	...
	public static double VRP[] = new double[] { 54, -180, 64 };
	public static double VPN[] = new double[] { 0, 1, 0 };
	public static double VUP[] = new double[] { 0, 0, 1 };
	...
	public static double Light[] = new double[] { 1, 0, 0 }; /* Light direction (unit length vector) */
